...
<html>
 <head>
  <title>$master_board_name - Buddy List</title>
  $headinclude
 ...
 <body id="bg" onload="document.bbform.addtolist.focus();">
  ...
  <td><table cellpadding=0 cellspacing=0 border=0 width="100%">
   <tr>
    <td><smallfont><b><a href="index.php?sid=$session[hash]">$master_board_name</a> » <a href="usercp.php?sid=$session[hash]">User CP of $wbbuserdata[username]</a> » Buddy List</b></font></td>
   ...
   <tr>
    <td width="200" valign="top">
     <table cellpadding=4 cellspacing=1 border=0 bgcolor="{tableinbordercolor}" width="200">
      <tr bgcolor="{tabletitlecolor}" id="tabletitle">
       <td colspan=4 align="center"><normalfont color="{fontcolorsecond}"><b>Buddy List</b></font></td>
      </tr>
      $listbit
     </table>
    </td>
    <td width="100%" valign="top">
     <table cellpadding=4 cellspacing=1 border=0 bgcolor="{tableinbordercolor}" width="100%">
      <tr>
       <td id="tablea" bgcolor="{tablecolora}"><normalfont><b>Add User:</b></font><br><smallfont>Enter the username of a member you want to add to your buddy list.</font></td>
