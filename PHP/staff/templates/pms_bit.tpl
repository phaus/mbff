<tr>
 <td id="tablea" bgcolor="{tablecolora}">$pm_image</td>
 <td id="tableb" bgcolor="{tablecolorb}">$icon</td>
 <td id="tablea" bgcolor="{tablecolora}" width="60%"><normalfont><a href="pms.php?action=viewpm&pmid=$row[privatemessageid]&sid=$session[hash]">$row[subject]</a></font></td>
