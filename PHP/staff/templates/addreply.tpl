...
<html>
<head>
<title>$master_board_name - Post Reply</title>
$headinclude
...
$header
 <tr bgcolor="{tablecolora}" id="tablea">
  <td><table cellpadding=0 cellspacing=0 border=0 width="100%">
   <tr>
    <td><smallfont><b><a href="index.php?sid=$session[hash]">$master_board_name</a>$navbar » <a href="thread.php?threadid=$threadid&sid=$session[hash]">$thread[topic]</a> » Post Reply</b></font></td>
...
<table cellpadding=4 cellspacing=1 border=0 width="{tableinwidth}" bgcolor="{tableinbordercolor}">
 <tr bgcolor="{tabletitlecolor}" id="tabletitle"><form action="addreply.php" method="post" name="bbform" onSubmit="return validate(this)">
  <td colspan=2><normalfont color="{fontcolorsecond}"><B>Post Reply</B></font></td>
 </tr>
...
<p align="center">
 ...
 <input class="input" type="submit" name="submit" accesskey="S" value="Post Reply">
...
<table cellpadding=4 cellspacing=1 border=0 width="{tableinwidth}" bgcolor="{tableinbordercolor}">
 <tr bgcolor="{tabletitlecolor}" id="tabletitle">
  <td colspan=2><normalfont color="{fontcolorsecond}"><B>Last $postcount Posts</B></font></td>
 </tr>
 $postbit
 $complete_thread
</table>
