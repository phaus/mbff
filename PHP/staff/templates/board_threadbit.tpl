<tr align="center">
  ...
  <td id="tablea" bgcolor="{tablecolora}" width="80%" align="left">$firstnew<normalfont>$prefix<a href="thread.php?threadid=$threads[threadid]&sid=$session[hash]">$threads[topic]</a></font>$multipages</td>
