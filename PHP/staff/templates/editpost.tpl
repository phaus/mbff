...
<html>
<head>
<title>$master_board_name - Edit Post</title>
$headinclude
...
function validate(theform) {
 if (theform.message.value=="") {
  alert("You must fill out the message field!");
  return false;
 }
 if (postmaxchars != 0) {
...
$header
 <tr bgcolor="{tablecolora}" id="tablea">
  <td><table cellpadding=0 cellspacing=0 border=0 width="100%">
   <tr>
    <td><smallfont><b><a href="index.php?sid=$session[hash]">$master_board_name</a>$navbar » <a href="thread.php?threadid=$threadid&sid=$session[hash]">$thread[topic]</a> » Edit Post</b></font></td>
    <td align="right"><smallfont><b>$usercbar</b></font></td>
   </tr>
  </table></td>
 </tr>
</table><br>$preview_window $editpost_error $editpost_delpost
<table cellpadding=4 cellspacing=1 border=0 width="{tableinwidth}" bgcolor="{tableinbordercolor}">
 <tr bgcolor="{tabletitlecolor}" id="tabletitle"><form action="editpost.php" method="post" name="bbform" onSubmit="return validate(this)">
  <td colspan=2><normalfont color="{fontcolorsecond}"><B>Edit Post</B></font></td>
 </tr>
 ...
 <tr bgcolor="{tablecolora}" id="tablea">
  ...
  <td><table>
   ...
   <tr>
    <td><textarea name="message" rows=15 cols=60 wrap="soft" onChange=getActiveText(this) onclick=getActiveText(this) onFocus=getActiveText(this)>$message</textarea><br><smallfont><a class="link" href="javascript:checklength(document.bbform);">Check message length</a></font></td>
   </tr>
  </table></td>
 </tr>
 <tr bgcolor="{tablecolorb}" id="tableb">
...
<p align="center">
 ...
 <input class="input" type="submit" name="submit" accesskey="S" value="Edit Post">
