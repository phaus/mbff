...
<body id="bg">
 ...
 <table border=0 cellpadding=4 cellspacing=1 width="{tableinwidth}" bgcolor="{tableinbordercolor}">
  <tr bgcolor="{tabletitlecolor}" id="tabletitle">
   <td><normalfont color="{fontcolorsecond}"><B>Login</B></font></td>
  </tr>
 ...
 <table border=0 bgcolor="{tableinbordercolor}" cellpadding=4 cellspacing=1 widht="300" align="center">
  <tr id="tableb" bgcolor="{tablecolorb}">
   ...
   <td><input type="text" class="input" name="l_username" SIZE=20 MAXLENGTH=50><smallfont> <a href="register.php?sid=$session[hash]">Register</a></font></td> 
  </tr>
  <tr id="tablea" bgcolor="{tablecolora}">
   <td><normalfont>Password:</font></td>
   <td><input type="password" class="input" name="l_password" SIZE=20 MAXLENGTH=30><smallfont> <a href="forgotpw.php?sid=$session[hash]">Forgot Password</a></font></td> 
  </tr>
 </table>
